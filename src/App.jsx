...
function calcularRepartoPropinas(startKey, endKey, monto, employees, recordsByDate) {
  const candidatos = employees
    ...
    .filter((c) => c.diasTrabajados > 0); // solo quienes checaron algo en el rango

  const totalDiasPropina = candidatos.reduce((s, c) => s + c.diasPropina, 0);
        ...
        <div className="flex-1 px-5 py-5 flex flex-col gap-4 overflow-y-auto">
          ...
          <div className="rounded-sm p-4" style={{ background: paper }}>
            ...
            {(() => {
              ...
              const { lista, sobrante } = calcularRepartoPropinas(propinasPeriodoInicio, fin, monto, employees, recordsByDate);
              return (
                <>
                  {lista.length === 0 ? (
