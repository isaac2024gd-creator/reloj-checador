...
export default function RelojChecador() {
  ...
  // ---------- estado de cobro (periodo de prueba / bloqueo por falta de pago) ----------
  // null mientras carga. Cuando ya cargó: { bloqueado, contratoAceptado, enPrueba,
  // diasRestantes, plan, precioMensual, nombreNegocio }.
  ...
  // "activarPago" se usa en la pantalla de bloqueo (prueba terminada), y
  // "abrirPortalSuscripcion" desde la tarjeta de Suscripción y pago (Nómina,
  // solo Dueño) — ambas llaman a Edge Functions de Supabase, nunca a Stripe
  ...
  const CONTRATO_VERSION_ACTUAL = "2026-09-17";
  ...
  // ---------- guardia de cobro: periodo de prueba vencido y sin suscripción activa ----------
  if (estadoAcceso && estadoAcceso.bloqueado) {
    return (
      <div className="min-h-screen w-full flex items-center justify-center p-6" style={{ background: charcoal }}>
        <div className="w-full max-w-sm rounded-sm p-6 text-center" style={{ background: paper }}>
          <AlertTriangle size={22} color={paprika} className="mx-auto mb-2" />
          <div className="text-sm font-bold mb-1" style={{ color: ink }}>Periodo de prueba terminado</div>
          <p className="text-xs mb-3" style={{ color: ink + "99" }}>
            {estadoAcceso.nombreNegocio ? `${estadoAcceso.nombreNegocio}: ` : ""}
            Tu periodo de prueba de {estadoAcceso.plan ? `el plan ${estadoAcceso.plan}` : "Reloj Checador"} ya terminó.
            Activa tu pago para seguir usando la app.
          </p>
    ...
    >
      ...
      <div className="px-5 pt-6 pb-4" style={{ borderBottom: `2px dashed ${steel}55` }}>
        ...
        {estadoAcceso && estadoAcceso.enPrueba && (
          ...
          >
            <Info size={13} color={brass} />
            <span className="text-[10px]" style={{ color: paper }}>
              {estadoAcceso.diasRestantes != null && estadoAcceso.diasRestantes > 0
                ? `Periodo de prueba: te quedan ${estadoAcceso.diasRestantes} día${estadoAcceso.diasRestantes === 1 ? "" : "s"}.`
                ...
                <div className="text-xs" style={{ color: ink }}>
                  ...
                  <div className="mt-1" style={{ color: ink + "88" }}>
                    ...
                    {estadoAcceso?.enPrueba
                      ? `en periodo de prueba (${estadoAcceso.diasRestantes ?? 0} día(s) restantes)`
